...
type SidebarIconName = "dashboard" | "add" | "patients" | "readmit" | "billing" | "pharmacy" | "lab" | "hrms" | "ot" | "employees" | "settings" | "logout" | "profile" | "appointment" | "alerts";
  ...
  return (
    <div className="app-shell">
      ...
      <main>
        ...
        {page === "op-queue-management" && hasPermission("patients.read") && <OpQueuePage setNotice={setNotice} />}
