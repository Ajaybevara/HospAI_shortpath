...
describe("LabPage", () => {
  test("renders lab billing, print, and existing diagnostic records", async () => {
    ...
    expect(container.textContent).toContain("Save Lab Bill");
    ...
    expect(container.querySelector('input[aria-label="Lab billing UHID"]')).toBeTruthy();
    expect(container.querySelector('input[aria-label="Lab billing patient name"]')).toBeTruthy();
    expect(container.querySelector('input[aria-label="Lab billing paid amount"]')).toBeTruthy();
