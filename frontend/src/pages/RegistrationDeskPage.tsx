...
export default function RegistrationDeskPage({ mode, selectedPatient, setNotice }: Props) {
      ...
      <section className="module-page">
        ...
        <div className="panel registration-desk-panel">
          ...
          <div className="form-actions">
            ...
            <Button variant="ghost" type="button" onClick={() => window.print()}>Print Consent</Button>
          </div>
  ...
  if (mode === "insurance") {
    const insurancePatientDetails = selectedInsurancePatient || selectedPatient;
    return (
      <section className="module-page">
        <div className="module-panel-head">
        ...
        <div className="panel registration-desk-panel">
          ...
          {insurancePatientDetails && (
            <div className="appointment-patient-card">
              <strong>{patientFullName(insurancePatientDetails) || insurancePatientDetails.name} ({insurancePatientDetails.patient_id})</strong>
              <span>UHID: {insurancePatientDetails.patient_id}</span><span>Age/Gender: {insurancePatientDetails.age || "-"} / {insurancePatientDetails.gender || "-"}</span><span>Mobile: {insurancePatientDetails.phone || "-"}</span><span>Address: {insurancePatientDetails.address || "-"}</span>
            </div>
          )}
