...
def generate_pdf(patient_name: str, doc_type: str, ocr_text: str, date_str: str = None) -> bytes:
    """Generate a hospital-standard A4 PDF with consistent HospAI branding."""
    if date_str is None:
    ...
    class HospitalDocumentPDF(FPDF):
        def footer(self):
            ...
            self.cell(0, 4, _pdf_clean("This document is system generated by HospAI. Verify clinical content before treatment decisions."), align="C", ln=True)
    ...
    def _draw_document_header():
        ...
        pdf.set_x(105)
        pdf.cell(90, 5, _pdf_clean("A4 print-ready clinical document"), align="R", ln=True)
        pdf.set_draw_color(13, 148, 169)
        pdf.set_line_width(0.6)
        pdf.line(left_margin, 34, 195, 34)
        pdf.set_text_color(0, 0, 0)
        pdf.set_y(39)
